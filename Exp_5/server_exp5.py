...
from blockchain import Blockchain, hash_weights
...
class FedAvgWithDefense(FedAvg):
    ...
    def aggregate_fit(self, server_round, results, failures):
        ...
        # ── 1. Collecte + décompression ──────────────────────────
        client_ids           = []
        weights_list         = []
        samples_list         = []
        client_attack_types  = {}
        total_bytes_received = 0
        compression_stats    = {}   # NOUVEAU : métriques compression par client
        ...
        for client_proxy, fit_res in results:
            ...
            # Octets reçus sur le réseau (compressés ou non)
            ...
            print(f"[Serveur] Client {client_id} (attack={attack_type}, "
                  f"compress={compress_on}) → {bytes_received/1024:.2f} KB reçus"
