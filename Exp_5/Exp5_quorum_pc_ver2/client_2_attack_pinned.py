# ============================================================
# client_2_attack_pinned.py : CLIENT 2 — EXPÉRIENCE 3 (attaques + blockchain)
# ============================================================
# Basé sur client_2_pinned.py (Expérience 1, épinglage cœur 3 conservé
...
#   python client_2_attack_pinned.py --server_ip 127.0.0.1 --attack_type label_flip
#   python client_2_attack_pinned.py --server_ip 127.0.0.1 --attack_type backdoor
# ============================================================
...
if __name__ == "__main__":
    ...
    # ÉPINGLAGE CPU : on réserve le cœur CPU_CORE (=3) UNIQUEMENT pour ce client
    ...
    # on crée le client avec son identifiant FIGÉ (CLIENT_ID = 2) et son attaque
